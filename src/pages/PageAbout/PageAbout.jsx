  ...
  render() {
    return (
      <div>
        <Helmet>
          <title>
            Фронтенд разработчик Дмитрий Кузьмин - образование, опыт, контакты,
            профессиональные навыки
          </title>
          <meta
            name="description"
            content="Информация обо мне, немного биографии до настоящего времени, скилы и контактные данные, по которым можно связаться со мной."
          />
        </Helmet>
        <PageLayout>
          <p>
            Меня зовут Дмитрий Кузьмин. Мне 23 года и в данный момент я
            начинающий front-end разработчик.
          </p>
          <p>
            В&nbsp;свободное время читаю книги, на которые делаю обзоры, изучаю
            и тестирую новые технологии.
          </p>
          <h2>Образование</h2>
          <ul>
            <li>
